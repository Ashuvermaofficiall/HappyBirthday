  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">Xyz ji!</h3>
      </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="text-center text-white">
              <p className="text-lg font-medium mb-4">Heyy xyz Tap Here to {isCardOpen ? "close" : "open"} </p>
